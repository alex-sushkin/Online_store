        ...
        <Container className="d-flex flex-column">
            ...
            <Dropdown className="mt-5 mb-3" style={{margin: "0 auto"}}>
                ...
                <Dropdown.Menu>
                    ...
                    {filter === "Without Brand or Type" ? <Dropdown.Item disabled>Без типа или производителя</Dropdown.Item> : <Dropdown.Item onClick={() => setFilter("Without Brand or Type")}>Без типа или производителя</Dropdown.Item>}
                </Dropdown.Menu>
            </Dropdown>
